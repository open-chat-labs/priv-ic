export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        app_profile_view: IDL.Func([AppProfileViewArgs], [AppProfileViewResponse], ["query"]),
        ...
        ext_verification_codes: IDL.Func([VerificationCodesArgs], [VerificationCodesResponse], []),
        profile: IDL.Func([ProfileArgs], [ProfileResponse], ["query"]),
        register_email: IDL.Func([RegisterEmailArgs], [RegisterEmailResponse], []),
